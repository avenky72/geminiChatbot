...
const geminiApiKey = 'AIzaSyAP3dKHq0wIivkxlDWrZ_wn5_RCBlYxjYs';
...
const Chatbot = () => {
  ...
  return (
    <div className="chatbot-container">
      ...
      <h3 className="chatbot-subhead">Doesn't Do Anything In Particular, Just Ask It Basic Questions</h3>
